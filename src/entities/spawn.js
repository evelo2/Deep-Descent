...
import { Shark, Octopus, Jelly, Puffer, Eel, Angler, Piranha, Stonefish } from './creatures.js';
...
export const ZONE_FAUNA = {
  ...
  deep:    [ {k:'shark',w:2,scale:'big'}, {k:'eel',w:2}, {k:'angler',w:2}, {k:'stonefish',w:1,minReef:2} ],
