...
import { Shark, Octopus, Jelly, Puffer, Eel, Angler, Piranha, Stonefish, Barracuda, Moray, ElectricRay } from './creatures.js';
...
export const ZONE_FAUNA = {
  ...
  deep:    [ {k:'shark',w:2,scale:'big'}, {k:'eel',w:2}, {k:'angler',w:2}, {k:'stonefish',w:1,minReef:2}, {k:'barracuda',w:1,minReef:3}, {k:'moray',w:1,minReef:3}, {k:'ray',w:1,minReef:3} ],
  dark:    [ {k:'eel',w:2}, {k:'jelly',w:1}, {k:'stonefish',w:3,minReef:1}, {k:'moray',w:2,minReef:2}, {k:'ray',w:1,minReef:3} ],
  wreck:   [ {k:'puffer',w:2}, {k:'eel',w:1}, {k:'moray',w:2,minReef:2} ],
  current: [ {k:'jelly',w:1} ],
